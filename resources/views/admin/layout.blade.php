...
<div id="helpModal" class="reveal-modal" data-reveal aria-labelledby="Help" aria-hidden="true" role="dialog">
  <h2>Help!</h2>
  <p>Use the page below to drag and drop endpoint or service group tiles into your preferred arrangement. When you are happy with the layout of the tiles hit the 'Save Layout' button in the menu bar.</p>
