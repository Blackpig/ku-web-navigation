	...
	private function getQuemis($id, $count=false)
	{
    	...
    	if (!$conn) {
			...
			$sql = 
				...
				FROM (
					SELECT  
						h.request_num as reference, to_char(h.date_raised, 'dd/mm/yy hh:mi') as created_at,l.loc_ref as title, h.desc_of_request as summary,  s.status as status, 'Quemis' as source 
